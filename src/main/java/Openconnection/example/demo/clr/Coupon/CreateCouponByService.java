...
public class CreateCouponByService implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        try {
            if (!couponService.couponExistsByTitleAndCompany("TRying", 0)) {
            ...
            if (!couponService.couponExistsByTitleAndCompany("Summer Sale", 1)) {
                couponService.addCoupon(Coupon.builder()
                        .companyId(1)
            ...
            if (!couponService.couponExistsByTitleAndCompany("BOGO Offer", 2)) {
                couponService.addCoupon(Coupon.builder()
                        .companyId(2)
            ...
            if (!couponService.couponExistsByTitleAndCompany("International Flight Offer", 3)) {
                couponService.addCoupon(Coupon.builder()
                        .companyId(3)
            ...
            if (!couponService.couponExistsByTitleAndCompany("Vacation Discount", 4)) {
                couponService.addCoupon(Coupon.builder()
                        .companyId(4)
            ...
            if (!couponService.couponExistsByTitleAndCompany("Computer Component Sale", 5)) {
                couponService.addCoupon(Coupon.builder()
                        .companyId(5)
