...
public class CouponService {
    ...
    public void addCouponPurchase(int couponID, int customerID) throws CouponNotFoundException, CouponOutOfStock {
        Coupon coupon = couponRepository.findById(couponID)
                .orElseThrow(() -> new CouponNotFoundException(ErrMsg.COUPON_NOT_FOUND.getMsg()));
        if (coupon.getAmount() == 0) {
            throw new CouponOutOfStock(ErrMsg.COUPON_OUT_OF_STOCK.getMsg());
